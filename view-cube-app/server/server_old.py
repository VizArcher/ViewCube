...
from trame.app import get_server
from trame.ui.vuetify3 import SinglePageLayout
from trame.widgets import iframe, vuetify3, vtk as vtk_widgets
...
# ---- Custom Interactor Style to capture mouse events ----
class CameraUpdateInteractorStyle(vtkInteractorStyleTrackballCamera):
    ...
    def left_button_release_event(self, obj, event):
        ...
        # state.dirty('camera_position')
        # state.dirty('camera_target')
        # state.dirty('camera_up')
...
renderWindowInteractor = vtkRenderWindowInteractor()
renderWindowInteractor.SetInteractorStyle(CameraUpdateInteractorStyle())
renderWindowInteractor.SetRenderWindow(renderWindow)
